...
/** Python type for FUPyWrapperSet */
extern PyTypeObject UPyWrapperSetType;
...
struct FUPyWrapperSet : public FUPyWrapperBase
{
	...
	static bool ValidateInternalState(FUPyWrapperSet* InSelf);

	/** Cast the given Python object to this wrapped type (returns a new reference) */
	static FUPyWrapperSet* CastPyObject(PyObject* InPyObject, FUPyConversionResult* OutCastResult = nullptr);
	...
	static FUPyWrapperSet* CastPyObject(PyObject* InPyObject, PyTypeObject* InType, const UPyUtil::FPropertyDef& InElementDef, FUPyConversionResult* OutCastResult = nullptr);
	...
	static int Clear(FUPyWrapperSet* InSelf);
	...
	static FUPyWrapperSet* Difference(FUPyWrapperSet* InSelf, PyObject* InOthers);
	...
	static int DifferenceUpdate(FUPyWrapperSet* InSelf, PyObject* InOthers);
	...
	static FUPyWrapperSet* Intersection(FUPyWrapperSet* InSelf, PyObject* InOthers);
	...
	static int IntersectionUpdate(FUPyWrapperSet* InSelf, PyObject* InOthers);
	...
	static FUPyWrapperSet* SymmetricDifference(FUPyWrapperSet* InSelf, PyObject* InOther);
	...
	static int SymmetricDifferenceUpdate(FUPyWrapperSet* InSelf, PyObject* InOther);
	...
	static FUPyWrapperSet* Union(FUPyWrapperSet* InSelf, PyObject* InOthers);
	...
	static int Update(FUPyWrapperSet* InSelf, PyObject* InOthers);
	...
	static int IsDisjoint(FUPyWrapperSet* InSelf, PyObject* InOther);

	/** Return true if there is another container contains this (equivalent to 'x.issubset(other)' in Python) */
	static int IsSubset(FUPyWrapperSet* InSelf, PyObject* InOther);

	/** Return true if there this container contains another (equivalent to 'x.issuperset(other)' in Python) */
	static int IsSuperset(FUPyWrapperSet* InSelf, PyObject* InOther);
};


typedef TUPyPtr<FUPyWrapperSet> FUPyWrapperSetPtr;
