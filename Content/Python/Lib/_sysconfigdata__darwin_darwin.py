...
build_time_vars = {
    ...
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/private/tmp/pythonA3.14-20260510-7823-pef39c/Python-3.14.5/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/private/tmp/pythonA3.14-20260510-7823-pef39c/Python-3.14.5/lcov-report',
    ...
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/private/tmp/pythonA3.14-20260510-7823-pef39c/Python-3.14.5/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.14-20260510-7823-pef39c/Python-3.14.5',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.14-20260510-7823-pef39c/Python-3.14.5 ./python.exe -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.14-20260510-7823-pef39c/Python-3.14.5 ./python.exe -E -m test',
    ...
    'abs_builddir': '/private/tmp/pythonA3.14-20260510-7823-pef39c/Python-3.14.5',
    'abs_srcdir': '/private/tmp/pythonA3.14-20260510-7823-pef39c/Python-3.14.5',
